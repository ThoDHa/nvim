...
vim.keymap.set("n", "<S-A-h>", "<C-w>>:redraw!<CR>", { desc = "Decrease window width" })
vim.keymap.set("n", "<S-A-l>", "<C-w><:redraw!<CR>", { desc = "Increase window width" })
vim.keymap.set("n", "<S-A-j>", "<C-w>+:redraw!<CR>", { desc = "Decrease window height" })
vim.keymap.set("n", "<S-A-k>", "<C-w>-:redraw!<CR>", { desc = "Increase window height" })
